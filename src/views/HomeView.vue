...
<template>
  <div class="home">
    <section class="hero">
      <div class="heroBg">
        <div class="heroOrb heroOrb1"></div>
      ...
      <div class="heroInner">
        <div class="heroBadge animate-fade-in-up">
...
.heroAccent {
  background: linear-gradient(135deg, var(--color-navy-accent) 0%, var(--color-navy-accent-hover, var(--color-navy-accent)) 100%);
